...
- [ ] Criar `Sallvat.sln` e projetos `Web`, `Application`, `Domain`, `Infrastructure`.
- [ ] Criar projetos `UnitTests` e `IntegrationTests`.
- [ ] Configurar referências permitidas e teste de arquitetura.
